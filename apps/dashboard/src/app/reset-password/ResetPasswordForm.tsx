...
export default function ResetPasswordForm() {
  ...
  const onFinish = async (values: { password: string }) => {
    try {
      ...
      if ((data as { resetPassword?: { success?: boolean } })?.resetPassword?.success) {
        setSuccess(true);
      } else {
        message.error(
          (data as { resetPassword?: { message?: string } })?.resetPassword?.message ??
  ...
  return (
    <div component="ResetPasswordForm" style={{ display: 'contents' }}>
      <AuthLayout heading="Set new password" subheading="Enter your new password below.">
