...
- Reviews after past visits (completed, or confirmed/seated after the slot ends) with Overall, Food, Service, and Atmosphere ratings plus up to 3 photos; partners reply from the dashboard Reviews page (optional Gemini draft via `GEMINI_API_KEY`) and can add diner photos to the gallery
