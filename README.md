...
- Partner **Floor plan** (rotatable tables, resizable canvas), **Floor ops** (per-area grids, silent 30s poll), and **Tables & shifts** (tabs + modal add/edit; searchable floor areas)
